...
CREATE TABLE tb_locacao (
	id SERIAL PRIMARY KEY,
	instante_locacao TIMESTAMPTZ NOT NULL,
	instante_devolucao TIMESTAMPTZ NOT NULL,
...
INSERT INTO tb_locacao (instante_locacao, instante_devolucao, cliente_id, carro_id, local_de_retirada_id) VALUES ('2017-09-30 10:34:00-03:00', '2017-10-04 11:10:00-03:00', '93838673610', 1, 1);
INSERT INTO tb_locacao (instante_locacao, instante_devolucao, cliente_id, carro_id, local_de_retirada_id) VALUES ('2017-11-11 09:00:00-03:00', '2017-11-15 10:00:00-03:00', '93838673610', 2, 1);
INSERT INTO tb_locacao (instante_locacao, instante_devolucao, cliente_id, carro_id, local_de_retirada_id) VALUES ('2017-12-25 00:00:00-03:00', '2018-07-31 00:00:00-03:00', '58236392715', 2, 1);

INSERT INTO tb_locacao_diaria (dias_previstos) VALUES (4);
INSERT INTO tb_locacao_diaria (dias_previstos) VALUES (4);

INSERT INTO tb_locacao_longo_periodo (porcentagem_desconto) VALUES (50.0);
